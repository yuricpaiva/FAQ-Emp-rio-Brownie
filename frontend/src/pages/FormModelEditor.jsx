...
const blankQuestion = () => ({ text: "", type: "TEXT", required: false, photoRequired: false, weight: 1 });
const blank = { name: "", description: "", active: true, resultType: "SIMPLE", scoreMin: 0, scoreMax: 10, scoreCalculationType: "SIMPLE_AVERAGE", requiresApproval: false, defaultObserverId: null, questions: [blankQuestion()], permissions: { fillRoles: [], fillUserIds: [], approveRoles: [], approveUserIds: [] } };
