  ...
  return <>
    <aside ref={sidebarRef} className={sidebarClasses} onClick={handleSidebarClick}>
      ...
      <nav className="sidebar__nav" aria-label="Navegação principal">
        <SidebarGroup label="Principal"><NavLink to="/" end className="sidebar__link"><Home className="sidebar__nav-icon" /><span className="sidebar__label">Início</span></NavLink></SidebarGroup>
